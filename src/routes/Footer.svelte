<footer class="container">
	<div>
		...
		<!-- Github icon -->
		<span>
			<a href="https://github.com/lucasvienna" title="Lucas's GitHub" aria-label="Lucas's GitHub">
		...
		<span>
			<a
				href="https://twitter.com/avyiel7"
				title="Avyiel7's Twitter"
				aria-label="Avyiel7's Twitter"
			>
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
					<path
		...
		<!-- Contact icon -->
		<span>
			<a href="/about" title="Contact me" aria-label="Contact">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
					<path
